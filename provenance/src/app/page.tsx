...
const Home: React.FC = () => {
  ...
  return (
    <div className="h-full bg-gradient-to-r from-gray-900 via-pink-700 to-purple-900 bg-cover bg-fixed leading-normal tracking-normal text-indigo-400">
      <div className="h-full pb-50">
        <div className="container mx-auto w-full">
          <div className="flex w-full items-center justify-between pt-4">
            ...
            <div className="flex w-80 content-center justify-between">
              <Link
                href="/marketplace"
        ...
        <div className="container mx-auto items-center pt-24 md:pt-36 mb-45">
